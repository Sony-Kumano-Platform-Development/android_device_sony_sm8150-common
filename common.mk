...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/extra/libjni_latinimegoogle.so:$(TARGET_COPY_OUT_PRODUCT)/lib/libjni_latinimegoogle.so \
    $(LOCAL_PATH)/extra/libjni_latinimegoogle_64.so:$(TARGET_COPY_OUT_PRODUCT)/lib64/libjni_latinimegoogle.so
